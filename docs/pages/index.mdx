...
Create `hugo.toml` if it doesn't exist in your site folder, and then enable Dream by adding:
...
Type below command in your terminal to create the first section about you:
...
You will then see **About** in the top right navagation bar. Click it to display your about page.
