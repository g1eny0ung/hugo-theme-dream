...
Make images zoomable in the single post page. This feature will use [medium-zoom](https://github.com/francoischalifour/medium-zoom) to implement.
...
<script type="module">
  ...
  // You can also further control the logic of zooming images. Like zooming lazy-loaded images.
</script>
```
</Callout>
