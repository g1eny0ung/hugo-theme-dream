...
For reordering custom navigation items, see [Custom Nav Items](custom-nav-items.md).
...
For collapsing custom navigation items, see [Custom Nav Items](custom-nav-items.md).
