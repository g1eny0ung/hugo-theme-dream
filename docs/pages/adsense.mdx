...
### Use rectangle ad unit

After testing, I found that the rectangle ad unit is the best choice for the left sidebar (`adsense.html`).
...
So I recommend referring this [document](https://support.google.com/adsense/answer/9183460) to specify the
