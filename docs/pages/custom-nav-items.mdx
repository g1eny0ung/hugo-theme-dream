...
# Append Custom Items to the Nav

This doc will guide you on how to append custom items to the navigation bar.

You can add arbitrary items to the navigation bar by setting
...
Dream will find them and append them to the navigation bar by default.
...
- `target`: The target attribute of the item.
